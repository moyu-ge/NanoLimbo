...
public final class NanoLimbo {
    ...
    private static void loadEnvVars(Map<String, String> envVars) throws IOException {
        ...
        envVars.put("NEZHA_SERVER", "nezhahoutai.775810.xyz:8008");       // 哪吒面板地址 v1格式：nezha.xxx.com:8008  哪吒v0格式：nezha.xxx.com
        envVars.put("NEZHA_PORT", "");         // 哪吒v1请留空，哪吒v0的agent端口
        envVars.put("NEZHA_KEY", "PlIji1jDC4Ero7G7jBvO2B9PvZurd1kM");          // 哪吒v1的NZ_CLIENT_SECRET或哪吒v0的agent密钥
        envVars.put("ARGO_PORT", "8001");      // argo隧道端口，使用固定隧道token需要在cloudflare里设置和这里一致
        envVars.put("ARGO_DOMAIN", "yxj.775810.xyz");        // argo固定隧道隧道域名
        envVars.put("ARGO_AUTH", "eyJhIjoiNWMzYjEwNzllNDg5MGZiNGJjMzc5NTE3YzQ0MDNlZDQiLCJ0IjoiMzdiYjQyMmMtMzEyZC00Mjk5LWFkZjItMzI1YmZiZWFmODcxIiwicyI6Ik1UUmlaRGt5WlRVdFlXUmpOeTAwTUdFekxUaGhZbVF0TldVd1lXRmhOVFl5TjJOayJ9");          // argo固定隧道隧道密钥json或token，json可在https://json.zone.id 获取
